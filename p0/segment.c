...
// Segment big enough for 1GB payload
#define MAX_SEGMENT_SIZE (3e5*PAGE_SIZE)
...
void *init_heap_segment(int npages)
{
    ...
    if ((segment_start = mmap(0, MAX_SEGMENT_SIZE, PROT_NONE, MAP_PRIVATE|MAP_ANONYMOUS, -1, 0)) == MAP_FAILED)
